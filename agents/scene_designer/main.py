#!/usr/bin/env python3
"""Scene Designer Agent — CLI entry point"""
import argparse
import json
import sys
...
from agents.scene_designer.core import *
...
def main():
    parser = argparse.ArgumentParser(description="Scene Designer Agent")
    ...
    if args.task_mode:
        ...
        worker = TaskWorker("scene_designer")
