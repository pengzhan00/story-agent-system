#!/usr/bin/env python3
"""Art Director Agent — CLI entry point"""
import argparse
import json
import sys
...
def main():
    parser = argparse.ArgumentParser(description="Art Director Agent")
    parser.add_argument("--action", required=True, help="Action to perform (color_palette, camera_language, review, style_guide)")
    ...
    if args.task_mode:
        ...
        worker = TaskWorker("art_director")
