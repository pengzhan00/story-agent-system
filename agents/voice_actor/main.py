#!/usr/bin/env python3
"""Voice Actor Agent — CLI entry point"""
import argparse
import json
import sys
...
from agents.voice_actor.core import *
...
def main():
    parser = argparse.ArgumentParser(description="Voice Actor Agent")
    parser.add_argument("--action", required=True,
                        help="Action to perform (generate_dialogue, save_script, list_lines)")
