#!/usr/bin/env python3
"""Reviewer Agent — CLI entry point"""
import argparse
import json
import sys
...
from agents.reviewer.core import *
...
def main():
    ...
    parser.add_argument("--action", required=True,
                        help="Action to perform (review_script, review_character, review_scene, review_project)")
