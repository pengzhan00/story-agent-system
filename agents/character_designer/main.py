#!/usr/bin/env python3
"""Character Designer Agent — CLI entry point"""
import argparse
import json
import sys
...
from agents.character_designer.core import *
...
def main():
    parser = argparse.ArgumentParser(description="Character Designer Agent")
    parser.add_argument("--action", required=True, help="Action to perform (design)")
    ...
    if args.task_mode:
        ...
        worker = TaskWorker("character_designer")
