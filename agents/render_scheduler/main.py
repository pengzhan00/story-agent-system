#!/usr/bin/env python3
"""Render Scheduler Agent — CLI entry point"""
import argparse
import json
import sys
...
from agents.render_scheduler.core import *
...
def main():
    parser = argparse.ArgumentParser(description="Render Scheduler Agent")
    parser.add_argument("--action", required=True,
                        help="Action to perform (schedule_render, check_status, submit_batch)")
    ...
    if args.task_mode:
        ...
        worker = TaskWorker("render_scheduler")
