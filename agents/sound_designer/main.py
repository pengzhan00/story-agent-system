#!/usr/bin/env python3
"""Sound Designer Agent — CLI entry point"""
import argparse
import json
import sys
...
from agents.sound_designer.core import *
...
def main():
    parser = argparse.ArgumentParser(description="Sound Designer Agent")
    parser.add_argument("--action", required=True, help="Action to perform (design_soundscape)")
    ...
    if args.task_mode:
        ...
        worker = TaskWorker("sound_designer")
