#!/usr/bin/env python3
"""Composer Agent — CLI entry point"""
import argparse
import json
import sys
...
from agents.composer.core import *
...
def main():
    parser = argparse.ArgumentParser(description="Composer Agent")
    parser.add_argument("--action", required=True, help="Action to perform (theme, bgm)")
